    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Müşteri numarası veya isim ile arama yapın</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex items-center relative">
            ...
            <Input
              type="text"
              placeholder="Müşteri No veya İsim"
              className="pl-9"
              value={searchQuery}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Sistemdeki tüm müşteri kayıtları</CardDescription>
        </CardHeader>
        <CardContent>
                ...
                {filteredCustomers.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={4} className="text-center py-4 text-muted-foreground">
                      {searchQuery ? "Arama sonucu bulunamadı." : "Henüz müşteri kaydı bulunmamaktadır."}
                    </TableCell>
                  </TableRow>
                ) : (
                    ...
                    <TableRow key={customer.id}>
                      ...
                      <TableCell className="text-right">
                        <Button variant="ghost" size="icon" asChild>
                          <Link href={`/customers/${customer.id}`}> {/* Assuming you have a customer detail page */}
